...
'''
Esta linha aplica o algoritmo Apriori ao DataFrame para encontrar conjuntos de itens
frequentes. O algoritmo Apriori é usado para minerar regras de associação, que são 
regras que descrevem associações entre itens em um conjunto de transações.
...
'''
a saída será: indice, support, itemsets onde o support é a probabilidade do itemset ser comprado
frequentemente por em outros itens e itemsets mostra os itens em si
'''
