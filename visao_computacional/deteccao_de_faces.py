...
imagem = cv2.imread('visao_computacional\imagens\pessoas.jpg')
...
'''
detector_face = cv2.CascadeClassifier('visao_computacional\codigos_treinados_cascadeClassifier\haarcascade_frontalface_default.xml')
...
'''
deteccoes = detector_face.detectMultiScale(imagem_cinza, scaleFactor=1.1, minSize=(10,10))
