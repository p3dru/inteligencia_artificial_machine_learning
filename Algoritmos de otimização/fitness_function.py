...
#retorna o preço dos vôos e passamos a nossa função personalizada
fitness = mlrose.CustomFitness(fitness_function)

#definimos o problema
#length é o tamanho da solução7
#fitness é afuncão fitness que passaremos
#maximize, define se queremos maximizar ou minimizar os atributos
#max_val é a quantidade de valor máximo de saídas entre 0 e 9 (números de vôos nesse caso)
